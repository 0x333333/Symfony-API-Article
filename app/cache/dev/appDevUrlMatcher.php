...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/search') && preg_match('#^/search/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
                goto not_acme_search_homepage;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'acme_search_homepage')), array (  '_controller' => 'Acme\\SearchBundle\\Controller\\DefaultController::getAction',  '_format' => 'json',));
        }
